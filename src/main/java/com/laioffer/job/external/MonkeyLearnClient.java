...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "76b62a126b150e9c77a219a590b796810b4ab8d7";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        request.setHeader("Authorization", "Token " + AUTH_TOKEN);// there must be a space after "Token".
        ...
        // Entity of request can be regarded as content;
        try {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            // json -> array of ExtractResponseItem
