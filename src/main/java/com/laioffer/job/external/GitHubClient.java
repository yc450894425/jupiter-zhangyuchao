...
public class GitHubClient {
    ...
    public List<Item> search(double lat, double lon, String keyword) {
        ...
        // Here we created an anonymous class. Just like new Comparator<>() {...}.
        // ResponseHandler is an interface, we need to implement its method.
        // lambda expression: response is parameter, method body is in the braces.
...
//            return Arrays.asList(itemArray);
        ...
        // execute the url and handle the response.
        try {
