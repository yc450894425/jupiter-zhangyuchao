...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (connection.verifyLogin(body.userId, body.password)) {
            // getSession() will create a session if request doesn't have a session.
            // we didn't set session id. Because once a session was created, server would send a cookie including session id to client.
